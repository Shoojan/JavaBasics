 ...
 */
public class OCR1 extends JFrame {

	class SymAction implements java.awt.event.ActionListener {
		public void actionPerformed(final java.awt.event.ActionEvent event) {
			final Object object = event.getSource();
			if (object == OCR1.this.downSample) {
				downSample_actionPerformed(event);
			} else if (object == OCR1.this.clear) {
				clear_actionPerformed(event);
			} else if (object == OCR1.this.add) {
				add_actionPerformed(event);
			} else if (object == OCR1.this.del) {
				del_actionPerformed(event);
			} else if (object == OCR1.this.load) {
				load_actionPerformed(event);
			} else if (object == OCR1.this.save) {
				save_actionPerformed(event);
			} else if (object == OCR1.this.train) {
				train_actionPerformed(event);
			} else if (object == OCR1.this.recognize) {
